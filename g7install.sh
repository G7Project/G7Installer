...
apptitle="G7Installer 2021.1 (GPLv3)"
...
# Get rid of ArchDi, we can't have that here!
# --------------------------------------------------------
# --------------------------------------------------------
pressanykey(){
...
loadstrings(){
	...
	txtconfigarchlinux="Config G7OS"
